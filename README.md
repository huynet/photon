...
**Photon** is an app that allows the user to search for locations using the [Foursquare API](https://developer.foursquare.com/docs) and create a pin with an image annotation.
...
<img src='photon.gif' title='Video Walkthrough' width='300' alt='Video Walkthrough' />
